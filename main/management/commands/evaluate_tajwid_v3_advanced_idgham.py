...
from main.utils_tilawah.tajwid_v3.detectors.advanced_idgham import SUPPORTED_RULE_CODES
...
class Command(BaseCommand):
    help = "Evaluasi exact-span Advanced Idgham v3 terhadap goldset Stage 5K."

    def add_arguments(self, parser):
        parser.add_argument("--fail-on-errors", action="store_true")
        parser.add_argument(
            "--output-dir",
            default="reports/tilawah/v3_advanced_idgham",
        )
    ...
    def handle(self, *args, **options):
        ...
        summary_path = output_dir / "tajwid_v3_advanced_idgham_summary.json"
        mismatch_path = output_dir / "tajwid_v3_advanced_idgham_mismatches.csv"
        ...
        self.stdout.write("Tajwid v3 — Advanced Idgham Evaluation")
        ...
        if options["fail_on_errors"] and not report.success:
            raise CommandError("Advanced Idgham v3 belum lulus goldset.")
