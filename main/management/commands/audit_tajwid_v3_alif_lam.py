...
from main.utils_tilawah.tajwid_v3.detectors.alif_lam import (
    AlifLamDetector,
...
class Command(BaseCommand):
    help = (
        "Audit corpus read-only untuk Alif Lam dan Lam Jalalah v3. "
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--output-dir", default="reports/tilawah/v3_alif_lam_corpus")
    ...
    def handle(self, *args: Any, **options: Any):
        ...
        self.stdout.write(f"Tajwid v3 Alif Lam corpus audit — Engine {ENGINE_VERSION}")
        ...
        summary_path = output_dir / "tajwid_v3_alif_lam_corpus_summary.json"
        issue_path = output_dir / "tajwid_v3_alif_lam_corpus_issues.csv"
        ayah_path = output_dir / "tajwid_v3_alif_lam_corpus_ayahs.csv"
        distribution_path = output_dir / "tajwid_v3_alif_lam_distribution.csv"
