...
AUDITED_RULE_CODES = MIM_RULE_CODES | GHUNNAH_RULE_CODES


class Command(BaseCommand):
    help = (
        "Audit corpus read-only untuk detector v3 Mim Sakinah dan Ghunnah "
        "Musyaddadah. Tidak membuat annotation set atau mengubah level ayat."
    )
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--output-dir",
            default="reports/tilawah/v3_mim_ghunnah_corpus",
        )
    ...
    def handle(self, *args: Any, **options: Any):
        ...
        summary_path = output_dir / "tajwid_v3_mim_ghunnah_corpus_summary.json"
        issue_path = output_dir / "tajwid_v3_mim_ghunnah_corpus_issues.csv"
        ayah_path = output_dir / "tajwid_v3_mim_ghunnah_corpus_ayahs.csv"
        distribution_path = output_dir / "tajwid_v3_mim_ghunnah_distribution.csv"
