...
class Command(BaseCommand):
    help = "Evaluasi exact-span detector v3 nun sakinah dan tanwin terhadap goldset."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--output-dir",
            default="reports/tilawah/v3_nun_tanwin",
        )
    ...
    def handle(self, *args, **options):
        ...
        summary_path = output_dir / "tajwid_v3_nun_tanwin_summary.json"
        mismatch_path = output_dir / "tajwid_v3_nun_tanwin_mismatches.csv"
        ...
        self.stdout.write("Tajwid v3 — Nun Sakinah/Tanwin Evaluation")
        ...
        if options["fail_on_errors"] and not report.success:
            raise CommandError("Detector nun/tanwin belum lulus goldset.")
