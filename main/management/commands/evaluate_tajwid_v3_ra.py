...
class Command(BaseCommand):
    help = "Evaluasi exact-span Ra Tafkhim/Tarqiq v3 terhadap goldset Stage 5J."

    def add_arguments(self, parser):
        parser.add_argument("--fail-on-errors", action="store_true")
        parser.add_argument("--output-dir", default="reports/tilawah/v3_ra")
    ...
    def handle(self, *args, **options):
        ...
        summary_path = output_dir / "tajwid_v3_ra_summary.json"
        mismatch_path = output_dir / "tajwid_v3_ra_mismatches.csv"
        ...
        self.stdout.write("Tajwid v3 — Ra Tafkhim/Tarqiq Evaluation")
        ...
        if options["fail_on_errors"] and not report.success:
            raise CommandError("Ra Tafkhim/Tarqiq v3 belum lulus goldset.")
