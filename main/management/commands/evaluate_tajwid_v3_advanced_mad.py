...
class Command(BaseCommand):
    help = "Evaluasi exact-span Advanced Mad Resolver v3 terhadap goldset Stage 5H."

    def add_arguments(self, parser):
        parser.add_argument("--fail-on-errors", action="store_true")
        parser.add_argument("--output-dir", default="reports/tilawah/v3_advanced_mad")
    ...
    def handle(self, *args, **options):
        ...
        summary_path = output_dir / "tajwid_v3_advanced_mad_summary.json"
        mismatch_path = output_dir / "tajwid_v3_advanced_mad_mismatches.csv"
        ...
        self.stdout.write("Tajwid v3 — Advanced Mad Evaluation")
        ...
        if options["fail_on_errors"] and not report.success:
            raise CommandError("Advanced Mad Resolver v3 belum lulus goldset.")
