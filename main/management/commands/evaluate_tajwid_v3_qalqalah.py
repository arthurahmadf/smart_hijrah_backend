...
from main.utils_tilawah.tajwid_v3.detectors.qalqalah import SUPPORTED_RULE_CODES
...
class Command(BaseCommand):
    help = "Evaluasi exact-span detector Qalqalah v3 terhadap goldset."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--output-dir",
            default="reports/tilawah/v3_qalqalah",
        )
    ...
    def handle(self, *args, **options):
        ...
        summary_path = output_dir / "tajwid_v3_qalqalah_summary.json"
        mismatch_path = output_dir / "tajwid_v3_qalqalah_mismatches.csv"
        ...
        self.stdout.write("Tajwid v3 — Qalqalah Evaluation")
        ...
        if options["fail_on_errors"] and not report.success:
            raise CommandError("Detector qalqalah belum lulus goldset.")
