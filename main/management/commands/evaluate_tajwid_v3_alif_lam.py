...
class Command(BaseCommand):
    help = "Evaluasi exact-span Alif Lam dan Lam Jalalah v3 terhadap goldset Stage 5I."

    def add_arguments(self, parser):
        parser.add_argument("--fail-on-errors", action="store_true")
        parser.add_argument("--output-dir", default="reports/tilawah/v3_alif_lam")
    ...
    def handle(self, *args, **options):
        ...
        summary_path = output_dir / "tajwid_v3_alif_lam_summary.json"
        mismatch_path = output_dir / "tajwid_v3_alif_lam_mismatches.csv"
        ...
        self.stdout.write("Tajwid v3 — Alif Lam/Lam Jalalah Evaluation")
        ...
        if options["fail_on_errors"] and not report.success:
            raise CommandError("Alif Lam/Lam Jalalah v3 belum lulus goldset.")
