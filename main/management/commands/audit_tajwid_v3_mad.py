...
from main.utils_tilawah.tajwid_v3.detectors.mad import (
    MadDetector,
    SUPPORTED_RULE_CODES as MAD_RULE_CODES,
)
...
AUDITED_RULE_CODES = MAD_RULE_CODES


class Command(BaseCommand):
    help = (
        "Audit corpus read-only untuk Mad Detector v3. Tidak membuat annotation "
        "set dan tidak mengubah level ayat."
    )
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--output-dir",
            default="reports/tilawah/v3_mad_corpus",
        )
    ...
    def handle(self, *args: Any, **options: Any):
        ...
        self.stdout.write(f"Tajwid v3 Mad corpus audit — Engine {ENGINE_VERSION}")
        ...
        for position, ayah in enumerate(
            ...
            except Exception as exc:  # corpus audit harus terus berjalan
            ...
            ayah_rows.append(
                {
                    ...
                    "provisional_count": sum(
                        1 for item in relevant if item.confidence < 1.0
                    ),
        ...
        summary_path = output_dir / "tajwid_v3_mad_corpus_summary.json"
        issue_path = output_dir / "tajwid_v3_mad_corpus_issues.csv"
        ayah_path = output_dir / "tajwid_v3_mad_corpus_ayahs.csv"
        distribution_path = output_dir / "tajwid_v3_mad_distribution.csv"
