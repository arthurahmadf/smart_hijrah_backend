...
class Command(BaseCommand):
    help = "Evaluasi exact-span Hamzat Wasl, silent letters, dan Saktah Stage 5L."

    def add_arguments(self, parser):
        parser.add_argument("--fail-on-errors", action="store_true")
        parser.add_argument(
            "--output-dir",
            default="reports/tilawah/v3_orthographic_waqf",
        )
    ...
    def handle(self, *args, **options):
        ...
        summary_path = output_dir / "tajwid_v3_orthographic_waqf_summary.json"
        mismatch_path = output_dir / "tajwid_v3_orthographic_waqf_mismatches.csv"
        ...
        self.stdout.write("Tajwid v3 — Orthographic/Waqf Evaluation")
        ...
        if options["fail_on_errors"] and not report.success:
            raise CommandError("Stage 5L belum lulus exact-span goldset.")
